      ...
      <div className="container" style={{ paddingTop: 36, paddingBottom: 36 }}>
        ...
        <section className="card" style={{ overflowX: 'auto' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead><tr style={{ textAlign: 'left', color: 'var(--muted)' }}><th style={{ padding: 12 }}>Nome</th><th style={{ padding: 12 }}>Email</th><th style={{ padding: 12 }}>Ruolo</th><th style={{ padding: 12 }}>Attivo</th><th style={{ padding: 12 }}></th></tr></thead>
            <tbody>
              {(profiles ?? []).map((item) => (
